...
angle_dict = {#구하고 싶은 각도들의 인덱스를 저장
    ...
    'L pelvis' : (11,13,12), #왼쪽 골반
    'R pelvis' : (12,14,11),  #오른쪽 골반 
    'L knee' : (13,15,11),  #왼쪽 무릎
    'R knee' : (14,16,12),  #오른쪽 무릎
    'L shoulder' : (5,7,11),  #왼쪽 어깨
    'R shoulder' : (6,8,12),  #오른쪽 어깨
    'L elbow' : (7,5,9),  #왼쪽 팔꿈치
    'R elbow' : (8,6,10)  #오른쪽 팔꿈치
}
            ...
            while self.running:
                ...
                if ret:
                    ...
                    if real_start:
                        ...
                        squat_rep2 = f"Rep2: {squat_set}"  
                        out_img = cv2.putText(out_img, squat_rep2, (350,100), cv2.FONT_HERSHEY_PLAIN, 4, color = (0,0,0), thickness=4)
