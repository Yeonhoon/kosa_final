...
def squat_down(ratio, ratio_arr, grad, squat_knee_angle, left_knee_angle, right_knee_angle):
    global color
    global test
        ...
        if ratio < ratio_arr[-5]:
            ...
            if left_knee_angle > squat_knee_angle * 1.2 and right_knee_angle > squat_knee_angle * 1.2: 
                ...
                color = (0,0,250)
                    ...
                    squat_knee_angle  <= right_knee_angle < squat_knee_angle * 1.3:
                test="Good"
                print('test :',test)
                color = (255,0,0)
            elif left_knee_angle < 80 or right_knee_angle < 80:
                test="Higher"
                color = (0,200,50)
    else: #올라갈 때 & 그냥 서있을때
        if ratio > ratio_arr[-5] + 0.2:
